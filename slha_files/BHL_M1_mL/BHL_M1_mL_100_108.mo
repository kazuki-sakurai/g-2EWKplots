...
========= SLHA file input =========
Initial file  "/Users/rafalmaselek/Projects/g-2/slha_files/BHL_M1_mL/BHL_M1_mL_100_108.spec"
...
~eL      : MSeL    = 118.179 || ~mL      : MSmL    = 118.179 || ~l1      : MSl1    = 118.191 
...
HiggsSignals(2.3.0)
  Nobservables=87 chi^2 = 9.48E+01 pval= 2.67E-01
LILITH(DB19.09):  -2*log(L): 130.81; -2*log(L_reference): 0.00; ndf: 66; p-value: 0.00E+00 
...
~1+ :   total width=2.61E-06 
 Branching  Partial width   Channel
 3.143E-01  8.195E-07 GeV   ~1+ -> u,D,~o1
 3.120E-01  8.137E-07 GeV   ~1+ -> S,c,~o1
 1.629E-01  4.248E-07 GeV   ~1+ -> nl,L,~o1
 1.054E-01  2.748E-07 GeV   ~1+ -> nm,M,~o1
 1.054E-01  2.748E-07 GeV   ~1+ -> ne,E,~o1
Example of 1->3 decay:
width(~o2->~o1,e,E)=1.742665e-07
