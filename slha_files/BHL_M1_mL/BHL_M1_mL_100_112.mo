...
========= SLHA file input =========
Initial file  "/Users/rafalmaselek/Projects/g-2/slha_files/BHL_M1_mL/BHL_M1_mL_100_112.spec"
...
~ne      : MSne    =  91.595 || ~nm      : MSnm    =  91.595 || ~nl      : MSnl    =  91.595 
~eL      : MSeL    = 121.846 || ~mL      : MSmL    = 121.846 || ~l1      : MSl1    = 121.856 
...
HiggsSignals(2.3.0)
  Nobservables=87 chi^2 = 9.44E+01 pval= 2.76E-01
LILITH(DB19.09):  -2*log(L): 130.41; -2*log(L_reference): 0.00; ndf: 66; p-value: 0.00E+00 
...
H3 :   total width=3.21E+02 
 ...
 1.611E-01  5.166E+01 GeV   H3 -> l,L
...
~1+ :   total width=2.54E-06 
 Branching  Partial width   Channel
 3.231E-01  8.195E-07 GeV   ~1+ -> u,D,~o1
 3.208E-01  8.137E-07 GeV   ~1+ -> S,c,~o1
 1.397E-01  3.544E-07 GeV   ~1+ -> nl,L,~o1
 1.082E-01  2.743E-07 GeV   ~1+ -> nm,M,~o1
 1.082E-01  2.743E-07 GeV   ~1+ -> ne,E,~o1
Example of 1->3 decay:
width(~o2->~o1,e,E)=1.750441e-07
