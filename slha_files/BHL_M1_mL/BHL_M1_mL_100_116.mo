...
========= SLHA file input =========
Initial file  "/Users/rafalmaselek/Projects/g-2/slha_files/BHL_M1_mL/BHL_M1_mL_100_116.spec"
...
~ne      : MSne    =  96.446 || ~nm      : MSnm    =  96.446 || ~nl      : MSnl    =  96.446 
~o3      : MNE3    = 125.014 || ~eL      : MSeL    = 125.532 || ~mL      : MSmL    = 125.532 
~l1      : MSl1    = 125.543 || ~uL      : MSuL    = 9000.000 || ~uR      : MSuR    = 9000.000 
...
HiggsSignals(2.3.0)
  Nobservables=87 chi^2 = 9.40E+01 pval= 2.84E-01
LILITH(DB19.09):  -2*log(L): 130.06; -2*log(L_reference): 0.00; ndf: 66; p-value: 0.00E+00 
...
H3 :   total width=3.21E+02 
 ...
 1.612E-01  5.167E+01 GeV   H3 -> l,L
...
~1+ :   total width=2.50E-06 
 Branching  Partial width   Channel
 3.273E-01  8.195E-07 GeV   ~1+ -> u,D,~o1
 3.249E-01  8.137E-07 GeV   ~1+ -> S,c,~o1
 1.289E-01  3.228E-07 GeV   ~1+ -> nl,L,~o1
 1.095E-01  2.741E-07 GeV   ~1+ -> nm,M,~o1
 1.095E-01  2.741E-07 GeV   ~1+ -> ne,E,~o1
Example of 1->3 decay:
width(~o2->~o1,e,E)=1.757110e-07
