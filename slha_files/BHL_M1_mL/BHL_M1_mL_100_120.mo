...
========= SLHA file input =========
Initial file  "/Users/rafalmaselek/Projects/g-2/slha_files/BHL_M1_mL/BHL_M1_mL_100_120.spec"
...
~o3      : MNE3    = 125.014 || ~eL      : MSeL    = 129.237 || ~mL      : MSmL    = 129.237 
~l1      : MSl1    = 129.248 || ~uL      : MSuL    = 9000.000 || ~uR      : MSuR    = 9000.000 
...
HiggsSignals(2.3.0)
  Nobservables=87 chi^2 = 9.37E+01 pval= 2.92E-01
LILITH(DB19.09):  -2*log(L): 129.74; -2*log(L_reference): 0.00; ndf: 66; p-value: 0.00E+00 
...
~1+ :   total width=2.49E-06 
 Branching  Partial width   Channel
 3.296E-01  8.195E-07 GeV   ~1+ -> u,D,~o1
 3.272E-01  8.137E-07 GeV   ~1+ -> S,c,~o1
 1.229E-01  3.056E-07 GeV   ~1+ -> nl,L,~o1
 1.102E-01  2.739E-07 GeV   ~1+ -> nm,M,~o1
 1.102E-01  2.739E-07 GeV   ~1+ -> ne,E,~o1
Example of 1->3 decay:
width(~o2->~o1,e,E)=1.762886e-07
