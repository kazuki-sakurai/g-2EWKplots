...
========= SLHA file input =========
Initial file  "/Users/rafalmaselek/Projects/g-2/slha_files/BHL_M1_mL/BHL_M1_mL_100_136.spec"
...
~o3      : MNE3    = 125.014 || ~eL      : MSeL    = 144.216 || ~mL      : MSmL    = 144.216 
~l1      : MSl1    = 144.226 || ~uL      : MSuL    = 9000.000 || ~uR      : MSuR    = 9000.000 
...
HiggsSignals(2.3.0)
  Nobservables=87 chi^2 = 9.28E+01 pval= 3.15E-01
LILITH(DB19.09):  -2*log(L): 128.76; -2*log(L_reference): 0.00; ndf: 66; p-value: 0.00E+00 
...
===============Neutrino Telescope=======  for  Sun
 E>1.0E+00 GeV neutrino/anti-neutrino fluxes   2.36E+15/3.36E+15 [1/Year/km^2]
...
H3 :   total width=3.21E+02 
 ...
 1.612E-01  5.170E+01 GeV   H3 -> l,L
...
~1+ :   total width=2.46E-06 
 Branching  Partial width   Channel
 3.331E-01  8.195E-07 GeV   ~1+ -> u,D,~o1
 3.307E-01  8.137E-07 GeV   ~1+ -> S,c,~o1
 1.138E-01  2.799E-07 GeV   ~1+ -> nl,L,~o1
 1.112E-01  2.736E-07 GeV   ~1+ -> nm,M,~o1
 1.112E-01  2.736E-07 GeV   ~1+ -> ne,E,~o1
Example of 1->3 decay:
width(~o2->~o1,e,E)=1.779778e-07
